...
master.minsize(600, 550) # minimum size possible
...
def open_file(event=None):
    new()
    file = filedialog.askopenfile(mode='r', encoding='utf-8')
    if file:
        global file_name
        file_name = file.name
        content = file.read()
...
def save(event=None):
    ...
    try:
        with open(file_name, mode='w', encoding='utf-8') as write_file:
            write_file.write(text.get("1.0", END))
    except Exception as e:
        messagebox.showerror("Error", f"Could not save file: {str(e)}")

def save_as(event=None):
    f = filedialog.asksaveasfile(mode='w', encoding='utf-8')
    if f is None: 
        return "break"
...
def load_icon(icon_path, size=(18, 18)):
    """Load and resize icon, return None if file not found"""
    try:
...
image_new = load_icon("icons/new.png")
if image_new:
...
image_save = load_icon("icons/save.png")
if image_save:
...
image_open = load_icon("icons/open.png")
if image_open:
...
image_copy = load_icon("icons/copy.png")
if image_copy:
...
image_cut = load_icon("icons/cut.png")
if image_cut:
...
image_paste = load_icon("icons/paste.png")
if image_paste:
...
image_redo = load_icon("icons/redo.png")
if image_redo:
...
image_undo = load_icon("icons/undo.png")
if image_undo:
...
image_find = load_icon("icons/find.png")
if image_find:
...
image_bold = load_icon("icons/bold.png")
if image_bold:
...
image_italic = load_icon("icons/italic.png")
if image_italic:
...
image_underline = load_icon("icons/underline.png")
if image_underline:
...
image_strike = load_icon("icons/strike.png")
if image_strike:
...
image_font_color = load_icon("icons/font-color.png")
if image_font_color:
...
image_highlight = load_icon("icons/highlight.png")
if image_highlight:
...
image_align_center = load_icon("icons/align-center.png")
...
image_align_justify = load_icon("icons/align-justify.png")
if image_align_justify:
...
image_align_left = load_icon("icons/align-left.png")
if image_align_left:
...
image_align_right = load_icon("icons/align-right.png")
...
file_menu.add_command(label="New", command=new, compound='left', image=image_new if image_new else None, accelerator='Ctrl+N', underline=0)
file_menu.add_command(label="Open", command=open_file, compound='left', image=image_open if image_open else None, accelerator='Ctrl+O', underline=0)
file_menu.add_separator()
file_menu.add_command(label="Save", command=save, compound='left', image=image_save if image_save else None, accelerator='Ctrl+S', underline=0)
...
edit_menu.add_command(label="Undo", command=undo, compound='left', image=image_undo if image_undo else None, accelerator='Ctrl+Z', underline=0)
edit_menu.add_command(label="Redo", command=redo, compound='left', image=image_redo if image_redo else None, accelerator='Ctrl+Y', underline=0)
edit_menu.add_separator()
edit_menu.add_command(label="Cut", command=cut, compound='left', image=image_cut if image_cut else None, accelerator='Ctrl+X', underline=0)
edit_menu.add_command(label="Copy", command=copy, compound='left', image=image_copy if image_copy else None, accelerator='Ctrl+C', underline=1)
edit_menu.add_command(label="Paste", command=paste, compound='left', image=image_paste if image_paste else None, accelerator='Ctrl+P', underline=0)
...
tool_menu.add_command(label="Search", command=find_text, compound='left', image=image_find if image_find else None, accelerator='Ctrl+F')
...
text.bind('<Control-v>', paste)  # Changed from Ctrl+P to Ctrl+V (standard paste)
...
def on_enter(event, str_msg):
    status.configure(text=str_msg)

def on_leave(event):
    status.configure(text="")

new_button.bind("<Enter>", lambda event, str_msg="New, Command - Ctrl+N": on_enter(event, str_msg))
new_button.bind("<Leave>", on_leave)

save_button.bind("<Enter>", lambda event, str_msg="Save, Command - Ctrl+S": on_enter(event, str_msg))
save_button.bind("<Leave>", on_leave)

open_button.bind("<Enter>", lambda event, str_msg="Open, Command - Ctrl+O": on_enter(event, str_msg))
open_button.bind("<Leave>", on_leave)

copy_button.bind("<Enter>", lambda event, str_msg="Copy, Command - Ctrl+C": on_enter(event, str_msg))
copy_button.bind("<Leave>", on_leave)

cut_button.bind("<Enter>", lambda event, str_msg="Cut, Command - Ctrl+X": on_enter(event, str_msg))
cut_button.bind("<Leave>", on_leave)

paste_button.bind("<Enter>", lambda event, str_msg="Paste, Command - Ctrl+V": on_enter(event, str_msg))
paste_button.bind("<Leave>", on_leave)

undo_button.bind("<Enter>", lambda event, str_msg="Undo, Command - Ctrl+Z": on_enter(event, str_msg))
undo_button.bind("<Leave>", on_leave)

redo_button.bind("<Enter>", lambda event, str_msg="Redo, Command - Ctrl+Y": on_enter(event, str_msg))
redo_button.bind("<Leave>", on_leave)

find_button.bind("<Enter>", lambda event, str_msg="Find, Command - Ctrl+F": on_enter(event, str_msg))
find_button.bind("<Leave>", on_leave)

bold_button.bind("<Enter>", lambda event, str_msg="Bold, Command - Ctrl+B": on_enter(event, str_msg))
bold_button.bind("<Leave>", on_leave)

italic_button.bind("<Enter>", lambda event, str_msg="Italic, Command - Ctrl+Shift+I": on_enter(event, str_msg))
italic_button.bind("<Leave>", on_leave)

underline_button.bind("<Enter>", lambda event, str_msg="Underline, Command - Ctrl+U": on_enter(event, str_msg))
underline_button.bind("<Leave>", on_leave)

align_justify_button.bind("<Enter>", lambda event, str_msg="Justify": on_enter(event, str_msg))
align_justify_button.bind("<Leave>", on_leave)

align_left_button.bind("<Enter>", lambda event, str_msg="Align Left, Command - Control-Shift-L": on_enter(event, str_msg))
align_left_button.bind("<Leave>", on_leave)

align_right_button.bind("<Enter>", lambda event, str_msg="Align Right, Command - Control-Shift-R": on_enter(event, str_msg))
align_right_button.bind("<Leave>", on_leave)

align_center_button.bind("<Enter>", lambda event, str_msg="Align Center, Command - Control-Shift-C": on_enter(event, str_msg))
align_center_button.bind("<Leave>", on_leave)

strike_button.bind("<Enter>", lambda event, str_msg="Strike": on_enter(event, str_msg))
strike_button.bind("<Leave>", on_leave)

font_color_button.bind("<Enter>", lambda event, str_msg="Font Color": on_enter(event, str_msg))
font_color_button.bind("<Leave>", on_leave)

highlight_button.bind("<Enter>", lambda event, str_msg="Highlight": on_enter(event, str_msg))
